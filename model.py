...
# InstanceNorm works better than BatchNorm for style transfer and generative models.
...
class ResidualBlock(nn.Module):
    def __init__(self, in_features):
        ...
        conv_block = [
            # ReflectionPad needed to preserve input and output dimensions;
            # otherwise the 3x3 kernel in Conv2d would reduce height and width of input by 2.
            nn.ReflectionPad2d(1),  # values at border reflected to create padding
            nn.Conv2d(in_features, in_features, 3),
            norm_layer(in_features),
            nn.ReLU(inplace=True),  # inplace=True to save memory when dealing with large tensors
    ...
    def forward(self, x):
        # Skip connection - help alleviate problem of vanishing gradients.
